...
{
    u8 tx_buf[50] = {0};
    if(pc2stm_mesg.gimbal_control_data.aim_pitch>=90||pc2stm_mesg.gimbal_control_data.aim_pitch<=-90){
        pc2stm_mesg.gimbal_control_data.aim_pitch=0;
        std::cout<<"算法发的pitch有误，请自查！！"<<std::endl;
    }
